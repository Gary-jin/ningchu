...
<template>
	<view class="container">
		...
		<view class="user-list  u-flex u-row-between " @tap="showCalendar = true">
		...
		<view class="user-list  u-flex u-row-between " v-if="userInfo.id!='302'">
			<text class="list-name">代理等级</text>
			<view class="u-flex">
				<text class="list-val">{{ userData.level_name || '暂无' }}</text>
				<text class="u-iconfont uicon-arrow-right u-m-l-20" style="color:#FFFFFF;"></text>
			</view>
		</view>
		<view class="user-list  u-flex u-row-between u-m-b-10" v-if="userInfo.id!='302'">
			<text class="list-name">福利等级</text>
			<view class="u-flex">
				<text class="list-val">{{ userData.welfare_name || '暂无' }}</text>
				<text class="u-iconfont uicon-arrow-right u-m-l-20" style="color:#FFFFFF;"></text>
			</view>
		</view>
