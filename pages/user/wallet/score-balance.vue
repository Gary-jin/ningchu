...
<template>
	<view class="page_box">
		<view class="head_box">
			<shopro-navbar :background="{ background: 'none' }" :backText="type=='score'?'积分余额':'复购积分余额'" backIconColor="#333"></shopro-navbar>
			<view class="all-box u-flex-col u-row-center u-col-center">
				<text class="all-num">{{type=='score'? userInfo.score || 0 : userInfo.repurchase_score || 0}}</text>
				<text class="all-title u-m-b-30">当前{{type=='score'?'积分':'复购积分'}}</text>
