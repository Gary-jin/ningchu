	...
	<view class="order-wrap">
		...
		<view class="u-m-b-10">
			...
			<block v-if="perGoodsList.length">
				...
				<!-- 积分 -->
				<view class="score item-list u-flex u-row-between" v-show="orderPre.discount_fee!=0">
					<view class="u-flex"><text class="item-title">优惠金额</text></view>
					<view class="price">{{ orderPre.discount_fee  }}</view>
				</view>
				<!-- 金额明细 -->
			...
			<view class="foot-box u-flex u-row-between safe-area-inset-bottom">
				<view class="u-flex">
					...
					<view class="all-money">
						<text>合计：</text>
						<text class="price">￥{{ (Number(orderPre.total_fee) + Number(orderPre.repurchase_score_amount)).toFixed(2) || '0.00' }}</text>
					</view>
				</view>
