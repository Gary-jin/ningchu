<template>
	...
	<view class="sh-wallet-box u-flex u-m-b-10 u-p-r-20">
		<view class="u-flex wallet-left">
			...
			<view class="wallet-item u-flex-col u-col-center" @tap="jump('/pages/user/wallet/score-balance',{type:'score'})">
				<text class="wallet-item__detail item-score u-ellipsis-1">{{ userInfo.score || '0' }}</text>
				<text class="wallet-item__title">积分</text>
			</view>
			<view class="wallet-item u-flex-col u-col-center" @tap="jump('/pages/user/wallet/score-balance',{type:'repurchase_score'})">
				<text class="wallet-item__detail item-score u-ellipsis-1">{{ userInfo.repurchase_score || '0' }}</text>
				<text class="wallet-item__title">复购积分</text>
			</view>
